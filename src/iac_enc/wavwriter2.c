...
void* wav_write_open(const char *filename, int sample_rate, int bits_per_sample, int channels) {
	return (wav_write_open2(filename, WAVE_FORMAT_PCM, sample_rate, bits_per_sample, channels));
}
*/
void* wav_write_open3(const char *filename, int format, int sample_rate, int bits_per_sample, int channels)
{
