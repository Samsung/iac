...
static int downmix_h4to2(DownMixer *dm, int dmix_type, int weight_type, int *w_x)
{
...
static int downmix_h2tofh2(DownMixer *dm, int dmix_type, int weight_type, int *w_x)
{
  int type_id = dmix_type - 1;
...
static int downmix_fh2(DownMixer *dm, int dmix_type, int weight_type, int *w_x)
{
...
static int downmix_s7to5(DownMixer *dm, int dmix_type, int weight_type, int *w_x)
{
  int type_id = dmix_type - 1;
  for (int i = 0; i < dm->frame_size; i++)
  {
...
static int downmix_s5to3(DownMixer *dm, int dmix_type, int weight_type, int *w_x)
{
  int type_id = dmix_type - 1;
  for (int i = 0; i < dm->frame_size; i++)
  {
...
static int downmix_s3to2(DownMixer *dm, int dmix_type, int weight_type, int *w_x)
{
  int type_id = dmix_type - 1;
  for (int i = 0; i < dm->frame_size; i++)
  {
...
static int downmix_s2to1(DownMixer *dm, int dmix_type, int weight_type, int *w_x)
{
  int type_id = dmix_type - 1;
  for (int i = 0; i < dm->frame_size; i++)
  {
...
int downmix(DownMixer *dm, unsigned char* inbuffer, int size, int dmix_type, int weight_type)
{
  ...
  for (int i = last_index; i >= 0; i--)
  {
    ...
    if(g_downmix[lay_out].data)
      ((void(*)(DownMixer *dm, int dmix_type, int weight_type, int *w_x))g_downmix[lay_out].data)
      (dm, dmix_type, weight_type, &weight_state_value_x_curr_int);
  }
